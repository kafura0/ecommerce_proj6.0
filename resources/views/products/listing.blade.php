        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">                
                    <div class="features_items"><!--features_items-->
                        ...
                        <div>&nbsp;</div>
                        <!---display all products in index page---->
                        @foreach($productsAll as $pro) 
                        <!--does not disaply product if image is null-->
                        @if(!empty($pro->image))                   
                        <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="{{ asset('/images/backend_images/products/small/'.$pro->image) }}" href="{{ url('product/'.$pro->id) }}" alt="" />
                                                <h2>Ksh. {{ $pro->price }}</h2>
                                                <p>{{ $pro->product_name }}</p>

                                                <a href="{{ url('product/'.$pro->id) }}" class="btn btn-default add-to-cart">
