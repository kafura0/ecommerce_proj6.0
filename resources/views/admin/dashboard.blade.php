      ...
      <div class="container-fluid">
        <div class="quick-actions_homepage">
          <ul class="quick-actions">
            ...
            <li class="bg_ly"> <a href="{{ url('/admin/view_categories') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Categories </a> </li>
            @endif
            @if(Session::get('adminDetails')['products_view_access']==1)
            <li class="bg_lo"> <a href="{{ url('/admin/view_products') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Products </a> </li>
            @endif
            @if(Session::get('adminDetails')['orders_access']==1)
            <li class="bg_ls"> <a href="{{ url('/admin/view_orders') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Orders </a> </li>
            @endif
            @if(Session::get('adminDetails')['users_access']==1)
            <li class="bg_lb"> <a href="{{ url('/admin/view_users') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Users </a> </li>
            @endif
