              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a href="{{ url('/admin/edit_cms_page/'.$page->id) }}" class="btn btn-primary btn-mini">Edit</a> 
                    <a href="{{ url('/admin/delete_cms_page/'.$page->id) }}" class="btn btn-danger btn-mini">Delete</a>
