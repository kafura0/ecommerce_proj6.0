      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit_cms_page/'.$cmsPage->id) }}" name="add_cms_page" id="add_cms_page" novalidate="novalidate">{{ csrf_field() }}
