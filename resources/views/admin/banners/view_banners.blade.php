              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a id="delBanner" rel="{{ $banner->id }}" rel1="delete_banner" href="javascript:" <?php /* href="{{ url('/admin/delete_banner/'.$banner->id) }}" */ ?> class="btn btn-danger btn-mini deleteRecord">Delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
