        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" method="post" action="{{ url('admin/add_coupon') }}" name="add_coupon" id="add_coupon">{{ csrf_field() }}
                <div class="control-group">
                  <label class="control-label">Coupon Code</label>
                    <div class="controls">
                      <input type="text" name="coupon_code" id="coupon_code" maxlength="50" minlength="5" required>
                    </div>
                </div>  
                <div class="control-group">
