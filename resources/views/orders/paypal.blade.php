...
<section id="do_action">
	<div class="container">
		<div class="heading" align="center">
			...
			<p>Your order number is {{ Session::get('order_id') }} and total payable about is KES {{ Session::get('grand_total') }}</p>
			...
			$addressArr = explode(',', $orderDetails->address);
			$getCountryCode = Order::getCountryCode($orderDetails->country);
			
			?>
			<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
				<input type="hidden" name="cmd" value="_xclick">
				<input type="hidden" name="business" value="sb-zcwuv176801@business.example.com">
				...
				<input type="hidden" name="address1" value="{{ $addressArr[0] }}">
				<input type="hidden" name="address2" value="{{ $addressArr[1] }}">
