	...
	<table width='700px'>
		...
		<tr><td>
			<table width='95%' cellpadding="5" cellspacing="5" bgcolor="#f7f4f4">
				...
				@endforeach
				<tr>
					<td colspan="5" align="right">Shipping<br> Charges</td><td>KES {{ $productDetails['shipping_charges'] }}</td>
				</tr>
				<tr>
					<td colspan="5" align="right">Coupon<br> Discount</td><td>KES {{ $productDetails['coupon_amount'] }}</td>
				</tr>
				<tr>
					<td colspan="5" align="right">Grand Total</td><td>KES {{ $productDetails['grand_total'] }}</td>
				</tr>
			</table>
		</td></tr>
		<tr><td>
