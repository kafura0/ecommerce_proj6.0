            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="single-widget">
                        <h2>Policies</h2>
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="{{ url('page/terms_conditions') }}">Terms of Use</a></li>
                            <li><a href="#">Privecy Policy</a></li>
                            <li><a href="{{ url('page/refund_policy') }}">Refund Policy</a></li>
        ...
        $.ajax({
            ...
            success: function(resp)
            {
                if(resp=="exists"){
                    ...
                    $("#btnSubmit").hide();
                    $("#statusSubscribe").html("<div style='margin-top:-10px' >&nbsp</div><font color='red'>Subscriber email already exists</font>");
                }
            },
            error:function(){
                alert("Error");
        ...
        $.ajax({
            ...
            success: function(resp)
            {
                if(resp=="exists"){
                    ...
                    $("#statusSubscribe").show();
                    $("#statusSubscribe").html("<div style='margin-top:-10px' >&nbsp</div><font color='green'>Success: Thanks for subscribing!</font>");
                }
            },
            error:function(){
                alert("Error");
