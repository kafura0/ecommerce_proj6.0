...
class CmsController extends Controller
{
    ...
    public function addCmsPage(Request $request){
    	if($request->isMethod('post')){
    		...
    		$cmspage->save();
    		return redirect('/admin/view_cms_pages')->with('flash_message_success','CMS Page has been added successfully');
    	}
    ...
    public function editCmsPage(Request $request,$id){
        if($request->isMethod('post')){
            ...
            return redirect('/admin/view_cms_pages')->with('flash_message_success','CMS Page has been updated successfully!');
        }
    ...
    public function contact(Request $request){
        if($request->isMethod('post')){
            ...
            $validator = Validator::make($request->all(), [
                //validate that no numbers are given in the name string
            ...
            // Send Contact Email
            $email = "joan.k.njoroge@gmail.com";
            $messageData = [
                'name'=>$data['name'],
                'email'=>$data['email'],
